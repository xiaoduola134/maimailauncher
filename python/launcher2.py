...
class GameLauncher:
    def __init__(self, root):
        ...
        self.card_file = self.base_dir / CARD_FILE  # 卡密存储文件
    ...
    def show_auth_window(self):
        ...
        self.auth_win.title(f"卡密验证 - 启动器 v{LAUNCHER_VERSION}")
    ...
    def activate_buttons(self):
        ...
        self.modify_hosts_btn.config(state=tk.NORMAL)  # 修改为modify_hosts_btn
    ...
    def create_widgets(self):
        ...
        tk.Label(title_frame, text=f"maimai启动器 v{LAUNCHER_VERSION}",  # 添加版本号
